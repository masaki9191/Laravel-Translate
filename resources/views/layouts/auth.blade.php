...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <style>
        ...
        .btn-bg {
            background-color: #73EF81; /* For browsers that do not support gradients */
            background-image: linear-gradient(to bottom, #73EF81, white);
            border-color:#707070
        }
        .section-content {
            min-height:95vh;
...
<body>
    ...
    <div id="app">
        ...
        <section class="section py-2 text-center bg-dark text-light">

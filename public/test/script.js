...
window.onload=function(){
    ...
    if(transferform){
        transferform.addEventListener("submit", transferformsubmit());
    }
    var amountinput = document.getElementById("#amount-input");
    if(amountinput){
        amountinput.addEventListener("change", amountinputchange());
    }
    var expressDashboardForm = document.querySelector('#disabled-accounts-form');
    if(expressDashboardForm){
        expressDashboardForm.addEventListener("submit", expressDashboardFormsubmit(expressDashboardForm));
    }
}
function expressDashboardFormsubmit(expressDashboardForm){

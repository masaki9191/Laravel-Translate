...
class ConversatorProfileController extends Controller
{
    ...
    public function create()
    {
        ...
        $countrys = json_decode(file_get_contents($path), true);
        return view('profile.conversator.create',compact('banks', 'countrys'));
    }
    public function store(Request $request)
    {
        ...
        return view('profile.conversator.thanks');
    }
    public function update_basic_get()
    {
        $path = storage_path() . "/json/country.json";
        $countrys = json_decode(file_get_contents($path), true);
        return view('profile.conversator.basic',compact('countrys'));
    }
    public function update_basic(Request $request)
    {
        ...
        return view('profile.conversator.update_thanks');
    }
    public function update_career_get()
    {
        return view('profile.conversator.career');
    }
    ...
    public function update_payment_get()
    {
        $path = storage_path() . "/json/bank/banks.json";
        $banks = json_decode(file_get_contents($path), true);
        return view('profile.conversator.payment',compact('banks'));
    }

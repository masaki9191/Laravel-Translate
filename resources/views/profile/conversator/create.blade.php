    ...
    <div class="container">
        <div class="row mt-sm-4">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <form id="form" method="POST" action="{{ route('profile.conversator.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            <!-- basic -->
                            <h5 class="mb-8"  style="padding-right: 15px;padding-left: 15px;">会話者情報</h5>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="sex" id="man" value="1" {{ auth()->user()->sex == 1  ? 'checked' : '' }}>
                                        <label class="form-check-label" for="sex">
                                            男性
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="sex" id="woman" value="2" {{ auth()->user()->sex == 2  ? 'checked' : '' }}>
                            ...
                            <div class="form-group row">
                                <label class="col-md-4">都道府県(日本在住の方)</label>
                                <div class="col-md-8">
                                    <input type="hidden" name="prefecture_name" id="prefecture_name" value="{{auth()->user()->prefecture_name}}">
                                    <select class="form-control @error('prefecture') is-invalid @enderror" name="prefecture" id="prefecture" data-live-search="true" >
                                        <option value="">-- 選んでください --</option>
                                        @foreach (config('myconfig.prefecture') as $prefecture)
                                            <option value="{{$prefecture['id']}}" {{ $prefecture['id'] === auth()->user()->prefecture  ? 'selected' : '' }} >{{$prefecture['name']}}</option>
                                         @endforeach
                                    </select>
                                    @error('prefecture')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4">国名(海外在住の方)</label>
                                <div class="col-md-8">
                                    <input type="hidden" name="country_name" id="country_name" value="{{auth()->user()->country_name}}">
                                    <select class="form-control @error('country') is-invalid @enderror" name="country" id="country" data-live-search="true" >
                                        <option value="">-- 選んでください --</option>
                                        @foreach($countrys as $key => $value)
                                            <option value="{{ $key }}"  {{ $key === auth()->user()->country  ? 'selected' : '' }} >{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('country')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control @error('overseas_experience') is-invalid @enderror" name="overseas_experience" >{{ old('overseas_experience') ?? auth()->user()->overseas_experience }}</textarea>
                                    @error('overseas_experience')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control @error('bilingual') is-invalid @enderror" name="bilingual" >{{ old('bilingual') ?? auth()->user()->bilingual }}</textarea>
                                    @error('bilingual')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            <!-- basic -->
                                <h5 class="mb-4"  style="padding-right: 15px;padding-left: 15px;">会話者情報</h5>
                                <div class="form-group row">
                                    <label class="col-md-4">氏名</label>
                                    <div class="col-md-8 row">
                                        <label for="" class="col-md-2">姓</label>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4">性別</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="modal_sex" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4">{{ __('都道府県') }}</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="modal_prefecture" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4">{{ __('国名(海外在住の方)') }}</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="modal_country" disabled>
                                    </div>
                                </div>
                                <!-- career -->
                                <h5 class="mt-16 mb-8"  style="padding-right: 15px;padding-left: 15px;">実績・スキルについて</h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#prefecture').change(function(){
            $("#prefecture_name").val($(this).find('option:selected').text());
        });
    ...
    function showModal()
    {
        ...
        if(sex.length > 0 ) {
            if(sex.val() == 1)
                $("input[name='modal_sex']").val("男性");
            else
                $("input[name='modal_sex']").val("女性");
        }
        $("input[name='modal_prefecture']").val($("#prefecture option:selected").text());
        $("input[name='modal_country']").val($("#country option:selected").text());

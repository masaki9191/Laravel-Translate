    ...
    <div class="card container">
        <div class="card-body">
            <div class="d-flex px-15 py-8">
                ...
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" type="radio" name="type" id="conversation" value="{{route('mypage.client.change',2)}}" checked>
            ...
            <div class="row">
                ...
                <div class="col-md-6 py-8" >
                    ...
                    <div class="content-bg-EAFDEC">
                        <div class="infor-box-t font-size-20"><div>セッション数について</div></div>
                        <button class="white-color-button font-size-20" onclick="window.location.href='{{route('conversation.ticketsList')}}'">利用セッション数を見る</button>
                    </div>
                </div>
            </div>
        </div>

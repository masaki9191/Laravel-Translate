...
<div class="card container">
    <div>
        <h4 class="ec_title font-size-50">ビジネス文書・メール</h4>
    </div>
    <div class="ec_content font-size-20 text-center">
        <div style="text-align:left;">
        誰もが知っているコピー機メーカーの海外売上比率は８０％を超えています。<br>
        どの会社、ビジネスシーンにおいても迅速、的確な情報を提供いたします。<br>
        </div>
    </div>
    <div class="ec_content_button">
        <a class="ec_button" href="{{ route('translation.create',2) }}"><span>利用する </span></a>
    </div>
    <div class="text-center">
        <div class="row">
            <div class="ec_content_sce col-md-5">
                <div class="ec_content_sce_title font-size-30">
                    <h6 class="font-size-30">一般文書 </h6>
                </div>
                <div class="font-size-20 my-8">
                    <div class="ec_content_sce_sm1">
                        日本語 ⇔ 対象言語<br>
                        １文字：{{$categorys[3]->price}}円
                    </div>
                </div>
            </div>
            ...
            <div class="ec_content_sce col-md-5">
                <div class="ec_content_sce_title">
                    <h6 class="font-size-30">プレゼンテーション </h6>
                </div>
                <div class="font-size-20 my-8">
                    <div class="ec_content_sce_sm1">
                        日本語 ⇔ 対象言語<br>
                        １文字：{{$categorys[4]->price}}円
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="ec_content_sce col-md-5">
                <div class="ec_content_sce_title">
                    <h6 class="font-size-30">ビジネスメール</h6>
                </div>
                <div class="font-size-20 my-8">
                    <div class="ec_content_sce_sm1">
                        日本語 ⇔ 対象言語<br>
                        １文字：{{$categorys[6]->price}}円
                    </div>
                </div>
            </div>
        </div>

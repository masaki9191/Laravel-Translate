...
class TranslatorProfileController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('profile.translator.create',compact('banks'));
    }
    public function store(Request $request)
    {
        ...
        return view('profile.translator.thanks');
    }
    public function update_basic_get()
    {
        return view('profile.translator.basic');
    }
    public function update_basic(Request $request)
    {
        ...
        return view('profile.translator.update_thanks');
    }
    public function update_career_get()
    {
        return view('profile.translator.career');
    }
    ...
    public function update_payment_get()
    {
        $path = storage_path() . "/json/bank/banks.json";
        $banks = json_decode(file_get_contents($path), true);
        return view('profile.translator.payment',compact('banks'));
    }

    ...
    <div class="container">
        <div class="row mt-sm-4">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <form id="form" method="POST" action="{{ route('profile.conversator.update_basic') }}" enctype="multipart/form-data">
                        @csrf
...
<script>
    ...
    function showModal()
    {
        ...
        $("input[name='modal_skype_id']").val($("input[name='skype_id']").val());

...
@section('content')
    <div class="card container">
        <div class="card-body">
            ...
            <div class="m-4"><a href="{{route('guide.interpreter')}}" class=""><通訳サービス利用ガイド</a>  </div>
            ...
            <div class="text-right">
                ...
                <form id="form" name="form" action="{{route('interpretation.payment.details')}}" method="post" class="" style="display:none">
                    @csrf
                </form>
            </div>
        </div>

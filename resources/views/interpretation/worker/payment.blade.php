            ...
            <div class="">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $sum_time/10*1000 }}円</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        </div>
        <form id="searchForm" name="searchForm" action="{{ route('interpretation.payment.details') }}" method="post" class="my-8 d-flex" style="align-item:center;justify-content:center">
            @csrf

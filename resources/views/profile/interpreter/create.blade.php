    ...
    <div class="container">
        <div class="row mt-sm-4">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <form id="form" method="POST" action="{{ route('profile.interpreter.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            <!-- basic -->
                            <h5 class="mb-8"  style="padding-right: 15px;padding-left: 15px;">通訳者情報</h5>
                            ...
                            <div class="form-group row">
                                <label class="col-md-4">{{ __('海外在住') }}</label>
                                <div class="col-md-8 row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="abroad" id="abroad" {{ auth()->user()->abroad == 1  ? 'checked' : '' }}>
                                        <label class="form-check-label" for="abroad">
                                        海外に在住されている場合はここにチェックをして下さい
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name" class="col-md-4">SkypeのID</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control @error('skype_id') is-invalid @enderror"
                                        name="skype_id" value="{{ old('skype_id') ?? auth()->user()->skype_id }}">
                                    @error('skype_id')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            <!-- basic -->
                                <h5 class="mb-4"  style="padding-right: 15px;padding-left: 15px;">通訳者情報</h5>
                                <div class="form-group row">
                                    <label class="col-md-4">氏名</label>
                                    <div class="col-md-8 row">
                                        <label for="" class="col-md-2">姓</label>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4">{{ __('海外在住') }}</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="modal_abroad" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4">{{ __('SkypeのID') }}</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="modal_skype" disabled>
                                    </div>
                                </div>
                                <!-- career -->
                                <h5 class="mt-16 mb-8"  style="padding-right: 15px;padding-left: 15px;">実績・スキルについて</h5>
...
<script>
    ...
    function showModal()
    {
        ...
        if(document.getElementsByName('abroad')[0].checked)
            $("input[name='modal_abroad']").val("海外在住です");
        else
            $("input[name='modal_abroad']").val("日本在住です。");
        $("input[name='modal_skype']").val($("input[name='skype_id']").val());
